const translations = {
  en: {
    ...
    'project.cnpj.result':  'Python pipeline automating a reconciliation I do manually in Excel — built to demonstrate ETL fundamentals.',
    ...
    'project.backup.result':  'Proof-of-concept integrating Zabbix data into Power BI — built to demonstrate monitoring-to-BI pipeline design.',

    'project.link.code':  'View Code',
    'project.tag.professional': 'Professional',
    'project.tag.personal':     'Personal Project',
    ...
    'demo.client.all':      'All',
    'demo.client.automotive': 'Automotive',
    'demo.client.industrial': 'Industrial',
    'demo.client.energy':     'Energy',
    'demo.client.hvac':       'HVAC',
    'demo.client.automation': 'Automation',
  ...
  pt: {
    ...
    'project.cnpj.result':  'Pipeline Python que automatiza uma reconciliação que faço manualmente no Excel — demonstra fundamentos de ETL.',
    ...
    'project.backup.result':  'Prova de conceito integrando dados do Zabbix no Power BI — demonstra design de pipeline monitoramento → BI.',

    'project.link.code':  'Ver Código',
    'project.tag.professional': 'Profissional',
    'project.tag.personal':     'Projeto Pessoal',
    ...
    'demo.client.automotive': 'Automotivo',
    'demo.client.industrial': 'Industrial',
    'demo.client.energy':     'Energia',
    'demo.client.hvac':       'HVAC',
    'demo.client.automation': 'Automação',
