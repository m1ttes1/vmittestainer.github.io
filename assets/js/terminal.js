(function () {
  ...
  var COMMANDS = {
    ...
    projects: function () { return [
      ...
      { text: '  [3] IronForge                   Flask + SQLite REST API + 4 dashboards' },
      { text: '  [4] Backup Monitoring           Power BI + Zabbix — 0 undetected incidents' },
      { text: '  [5] CAGED Indústria SP          SQL + DuckDB — SP manufacturing trends 2021–2024' },
      { text: '' },
